...
**表情与点游戏**：竞技场顶栏每队一排 4 个表情键 🔥 加油 / 😆 哈哈 / 😱 哇 / 😎 厉害（两人一台两排都有，打机器人 / 多设备只有自己那排，只观战的设备在时钟旁有一排），点了从自己这边飞向对方那边、一声「啵嘤」，🔥 还会读一声「加油！」；机器人会回应（收到表情回一个，反超 😎、被反超 😱，赢了 😎、输了给你 🔥）；多设备房间里表情经服务器转给房间里所有人，家长在主持设备上就能给孩子加油。游戏画面也能点：点一下那一队的角色它会有反应（火车鸣笛喷汽、乌龟 / 兔子跳一下、火箭喷一口火、企鹅拍翅膀……每种游戏各不一样），点按处一圈涟漪、小声放这种游戏的得分音，不计分。

**幸运题与本章战绩**：每人 8 题里有一道幸运题（由题目流的种子定，第 2–7 题之一，题干右上角有 ✨），答对了撒金色彩纸 + 烟花声 + 弹「幸运题！」，分数照旧 1 分；同一个知识点连着「再来一局」，结果页记「本章战绩：小兔 2 : 1 小虎」，先赢两局的名字旁出 🏆，换知识点或离开清零、不存本地。

**我的小动物**：进对战前选一只自己的小动物（🐻 小熊、🐷 小猪、🐼 熊猫、🐵 小猴、🐰 小兔、🐱 小猫；「⚙️ 配置」里和问名字的面板里都能选，两人一台左右各选各的），名字旁、结果页都带它，赛车 / 开火车的司机、热气球的乘客换成它；多设备时随进房发给服务器，别人也看得到。

**幽灵对手**：打机器人时，这个知识点如果有上一次打完的记录，设置页多一个「👻 跟上次的自己比」：对手换成上一次的自己（👻 + 名字 + 小动物），按上次每题答完的时刻与对错一题一题重放，不说话、不发表情；每打完一局机器人都把这一局记下来（只记最近一次、最多 20 个知识点，只在本机），不排名、不比别人。

**机器人**：快慢默认「跟着你」——按你最近几题的平均用时定它的用时（略慢一点），你落后 3 分它再慢一截、领先 3 分它快一截，正确率也跟着你的（略低），每局都能打到六七分才见分晓；「⚙️ 配置」里仍可选固定的慢 / 中 / 快。它还会说话：开局「我准备好啦！」、自己反超「我领先啦！」、被反超「哎呀，被追上了」、你还差一分「别急别急」、输了「你太厉害了，再来一局吧」、赢了「这次我赢啦，再来一局？」，它那一行冒气泡（带拼音）同时朗读，声音调高一点像机器人，不打断读题。
