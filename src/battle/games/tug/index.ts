/**
 * 拔河（需求 B36d）：把模型与渲染组装成 GameModule。
...
import { TugModel } from './model'
import { renderBackground, renderDynamic } from './render'

export function createTugGame(): GameModule {
  ...
  return {
    ...
    mount(host: GameHostInfo) {
      ...
      model = new TugModel(createRng(), { reducedMotion: host.reducedMotion })
      relayout()
    },
