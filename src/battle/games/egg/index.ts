/**
 * 孵蛋（需求 B36n）：把模型与渲染组装成 GameModule。
...
import { EggModel } from './model'
import { renderBackground, renderDynamic } from './render'

export function createEggGame(): GameModule {
  ...
  return {
    ...
    mount(host: GameHostInfo) {
      ...
      model = new EggModel(createRng(), { reducedMotion: host.reducedMotion })
      relayout()
    },
