/**
 * 游泳（需求 B36i）：把模型与渲染组装成 GameModule。
...
import { SwimModel } from './model'
import { renderBackground, renderDynamic } from './render'

export function createSwimGame(): GameModule {
  ...
  return {
    ...
    mount(host: GameHostInfo) {
      ...
      model = new SwimModel(createRng(), { reducedMotion: host.reducedMotion })
      relayout()
    },
