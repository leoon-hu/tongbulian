/**
 * 融冰（需求 B36e）：把模型与渲染组装成 GameModule。
...
export function createIceGame(): GameModule {
  ...
  return {
    ...
    mount(host: GameHostInfo) {
      ...
      model = new IceModel(createRng(), { reducedMotion: host.reducedMotion })
      relayout()
    },
