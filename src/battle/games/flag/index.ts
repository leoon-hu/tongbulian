/**
 * 抢旗（需求 B36t）：把模型与渲染组装成 GameModule。
...
export function createFlagGame(): GameModule {
  ...
  return {
    ...
    mount(host: GameHostInfo) {
      ...
      model = new FlagModel(createRng(), { reducedMotion: host.reducedMotion })
      relayout()
    },
