/**
 * 钓鱼（需求 B36l）：把模型与渲染组装成 GameModule。
...
export function createFishGame(): GameModule {
  ...
  return {
    ...
    mount(host: GameHostInfo) {
      ...
      model = new FishModel(createRng(), { reducedMotion: host.reducedMotion })
      relayout()
    },
