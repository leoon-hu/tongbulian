...
// 「跟谁打」四张卡的示意图（B27）：一台手机横着放，左半边红队、右半边蓝队；
...
<template>
  <svg class="mode-pic" viewBox="0 0 120 72" aria-hidden="true" focusable="false">
    <!-- 一台横屏手机：打机器人 / 两人一台 -->
    <g v-if="mode === 'ai' || mode === 'duo'" class="phone landscape">
    ...
    <!-- 一台竖屏手机、一个人捧着书：自己练 -->
    <g v-else-if="mode === 'practice'" class="phone portrait">
      <rect class="body" x="35" y="2" width="50" height="68" rx="10" />
      <rect class="half solo" x="41" y="8" width="38" height="56" rx="5" />
      <rect class="notch" x="56" y="4" width="8" height="2" rx="1" />
      <g class="person solo">
        <circle cx="60" cy="25" r="8.5" />
        <path d="M46 55A14 13 0 0 1 74 55Z" />
      </g>
      <g class="book">
        <path d="M60 46L47.5 42.5V55L60 58.5Z" />
        <path d="M60 46L72.5 42.5V55L60 58.5Z" />
      </g>
    </g>
