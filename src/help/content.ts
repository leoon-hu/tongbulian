  ...
  return [
    {
      ...
      blocks: [
        ...
        {
          kind: 'p',
          text: '更多玩法：顶栏有自己队的一排表情 🔥 😆 😱 😎，点了飞到对方那边，机器人会回应，「各用各的」时观战的人也能发；点游戏画面里自己队的角色它会有反应（火车鸣笛、乌龟跳一下……），还会冒个对话框说一句自己的台词。机器人快慢默认「跟着你」，还会说话。8 题里有一道幸运题 ✨，答对撒金色彩纸；7 : 7 是决胜题；到 8 分画面会放大对准赢的那一边。「⚙️ 配置」里可以选自己的小动物、关背景音乐；同一个知识点连着打，结果页记本章战绩；打机器人时还可以「👻 跟上次的自己比」。',
        },
      ],
    },
    {
